...
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Venom")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "https://t.me/+C2hDn6h_gABhMjE9")
#    GROUP_USERNAME = os.getenv("Filmi indian hindi 2.0")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "Filmi_indian_hindi")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @filmi_indian_hindi_official_1""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
...
ʀᴇɢᴀʀᴅs - @filmi_indian_hindi_official_1"""
...
⭕️ How to watch movie from links  ⭕️
